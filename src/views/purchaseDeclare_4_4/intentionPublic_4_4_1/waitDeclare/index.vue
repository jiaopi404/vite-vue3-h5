<template>
  <div>
    <BasicTable @register="registerTable" @fetch-success="onFetchSuccess">
      <template #toolbar>
        <a-button type="primary" @click="handleCreate"> 意向公开申报 </a-button>
      </template>
  ...
  export default defineComponent({
    ...
    setup() {
        ...
        useHqlQueryDto({
          hqlPageAndSortSumDto: {
            ...
            queryList: [
              ...
              { param: 'project.status.code', type: 'equal', value: [6] },
      ...
      function handleCreate() {
        router.push('/disclosure/intention');
      }

      function handleEdit(record: Recordable) {
        const proId = toRaw(record).id;
        router.push(`/disclosure/intention?id=${proId}`);
      }
