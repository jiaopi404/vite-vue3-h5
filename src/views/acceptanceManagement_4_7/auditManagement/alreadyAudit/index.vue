...
<script lang="ts" setup>
  ...
  import { getProAcceptanceFlowAlreadyDoneListBySqlPageAndSortSumDto } from '/@/api/auditMangement/auditMangement';
  ...
  const [registerTable] = useTable({
    ...
    api: async (params) => {
      try {
        ...
        return await getProAcceptanceFlowAlreadyDoneListBySqlPageAndSortSumDto(params);
      } catch (err) {
    ...
    beforeFetch: (queryInfo: any) => {
      ...
      if (queryInfo.projectTypeName) {
        appendQueryList({
          param: 'alreadyDone.projectTypeName',
          type: 'equal',
