<template>
  <div>
    <BasicTable @register="registerTable" @fetch-success="onFetchSuccess">
      <template #toolbar>
        <a-button type="primary" @click="handleCreate"> 添加采购计划 </a-button>
      </template>
...
<script lang="ts">
  ...
  import { columns, searchFormSchema } from './waitPurchase.data';
  import {
    deleteProjectById,
    getProjectPage,
    submitVerification,
  ...
  export default defineComponent({
    ...
    setup() {
        ...
        useHqlQueryDto({
          hqlPageAndSortSumDto: {
            ...
            queryList: [
              ...
              { param: 'project.status.code', type: 'equal', value: [1] },
      ...
      function handleCreate() {
        router.push('/purchasePlan_4_2/purchase');
      }

      function handleEdit(record: Recordable) {
        const proId = toRaw(record).id;
        router.push(`/purchasePlan_4_2/purchase?id=${proId}`);
      }
