...
<script lang="ts">
  ...
  import { getProjectPage, getActRuTaskByProcessId } from '/@/api/purchase/plan-purchase';
  ...
  export default defineComponent({
    ...
    setup() {
        ...
        useHqlQueryDto({
          hqlPageAndSortSumDto: {
            ...
            queryList: [
              ...
              { param: 'project.status.code', type: 'in', value: [2] },
      ...
      const onChange = (pagination, filters, sorter, { currentDataSource }) => {
        resetHqlQueryDto(); // 先重置
        console.log('onChange的参数', pagination, filters, sorter, { currentDataSource });
        return;
      };
