<template>
  <div>
    <BasicTable @register="registerTable" @fetch-success="onFetchSuccess">
      <template #toolbar>
        <a-button type="primary" @click="handleCreate"> 添加立项 </a-button>
      </template>
...
<script lang="ts">
  ...
  import { columns, searchFormSchema } from './waitInitiation.data';
  import {
    deleteProjectById,
    getProjectPage,
    submitVerification,
  ...
  export default defineComponent({
    ...
    setup() {
        ...
        useHqlQueryDto({
          hqlPageAndSortSumDto: {
            ...
            queryList: [
              ...
              { param: 'project.status.code', type: 'equal', value: [4] },
      ...
      function handleCreate() {
        router.push('/projectManagement_4_3/initiation');
      }

      function handleEdit(record: Recordable) {
        const proId = toRaw(record).id;
        router.push(`/projectManagement_4_3/initiation?id=${proId}`);
      }
