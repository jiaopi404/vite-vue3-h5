...
<script lang="ts">
  ...
  // 配置数据
  import { columns, searchFormSchema } from './approved.data';
  import { useHqlQueryDto } from '/@/hooks/web/useHqlQueryDto';
  import {
    getProjectPage,
    getActRuTaskByProcessId,
  } from '/@/api/projectManagement/projectManagementApi';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      // 组织查询参数
      const { appendQueryList, getHqlQueryDto, resetHqlQueryDto, setSorts, setPage } =
        useHqlQueryDto({
          hqlPageAndSortSumDto: {
            ...
            queryList: [
              ...
              { param: 'project.projectAdditionPhase', type: 'in', value: [1, 2] },
            ],
