        ...
        <LxBasicExportBtn
          ...
          :exportExcelDto="{
            ...
            listDataColumn: [
              ...
              ExportColumnMap[ExportColumnKeyEnum.CONTRACT_STATUS],
...
<script lang="ts" setup>
  ...
  import { roleListTableSchema, roleSearchFormSchema } from './waitSigned.data';
  ...
  const { appendQueryList, getHqlQueryDto, resetHqlQueryDto, setPage, setSorts } = useHqlQueryDto({
    hqlPageAndSortSumDto: {
      queryList: [
        ...
        { param: 'conContract.status.code', type: 'in', value: [1, 2, 3, 4] },
        // 获取授权部门
        {
