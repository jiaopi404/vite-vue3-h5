    ...
    setup() {
      ...
      const beforeFetch = (queryInfo: any) => {
        ...
        if (queryInfo.proName) {
          console.log(queryInfo.proName, 'queryInfo.proName');
          appendQueryList({
        ...
        // const queryDto: any = getSqlQueryDto();
      ...
      // 查看评审信息
      function clickViewReviewDetails(record: Recordable) {
        router.push({
          path: '/viewReviewDetails',
