...
import { SqlQueryDtoI } from '/#/business';
...
enum Api {
  ...
  // 查询我的业务
  GetMyBusinessTask = '/project/myBusinessTask',
}
...
export const getMyBusinessTask = (data: SqlQueryDtoI) =>
  defHttp.post<any>({ url: Api.GetMyBusinessTask, data });
